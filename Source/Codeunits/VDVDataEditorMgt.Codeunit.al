...
codeunit 72995576 "VDV Data Editor Mgt."
{
    ...
    var
        ...
        DataEditorSetup: Record "VDV Data Editor Setup";
        EditValue: page "VDV Edit Value";
    ...
    var
        ...
        ImportExportDialog: Page "VDV Import/Export Dialog";
        ImportOnFind: Enum "VDV Import On Find";
        FileFormat: Enum "VDV File Format";
    ...
    local procedure ImportExcel(var FileInStream: InStream; ImportOnFind: Enum "VDV Import On Find"; WithValidation: Boolean)
    var
    ...
    local procedure ImportJSON(var FileInStream: InStream; ImportOnFind: Enum "VDV Import On Find"; WithValidation: Boolean)
    var
        DataEditorSetup: Record "VDV Data Editor Setup";
        RecRef: RecordRef;
        xRecRef: RecordRef;
    ...
    local procedure UpdateRecord(ValueAsTxt: Text; var RecRef: RecordRef; var xRecRef: RecordRef; var FieldRef: FieldRef; ImportOnFind: Enum "VDV Import On Find"; IsRecordExist: Boolean; WithValidation: Boolean; IsLogEnabled: Boolean)
    var
        xFieldRef: FieldRef;
    begin
    ...
    local procedure SaveRecord(var RecRef: RecordRef; ImportOnFind: Enum "VDV Import On Find"; WithValidation: Boolean; IsRecordExist: Boolean; var Inserted: Integer; var Skipped: Integer; var Modified: Integer; IsLogEnabled: Boolean)
    begin
    ...
    procedure ExportTable(var DataEditorBuffer: Record "VDV Data Editor Buffer"; FieldIdsToExport: List of [Integer])
    var
        ImportExportDialog: Page "VDV Import/Export Dialog";
        FileFormat: Enum "VDV File Format";
    ...
    local procedure ExportExcel(var DataEditorBuffer: Record "VDV Data Editor Buffer"; FieldIdsToExport: List of [Integer]; ExportBLOB: Boolean; ExportMedia: Boolean)
    var
        TempExcelBuffer: Record "Excel Buffer" temporary;
        TempBlob: Codeunit "Temp Blob";
        RecRef: RecordRef;
    ...
    var
        TempBinaryDataBuffer: Record "VDV Binary Data Buffer" temporary;
        TempBlob: Codeunit "Temp Blob";
    ...
    local procedure ExportJSON(var DataEditorBuffer: Record "VDV Data Editor Buffer"; FieldIdsToExport: List of [Integer]; ExportBLOB: Boolean; ExportMedia: Boolean)
    var
        TempBlob: Codeunit "Temp Blob";
        RecRef: RecordRef;
    ...
    var
        ...
        NewValue: FieldRef;
    begin
        Log(Enum::"VDV Log Action Type"::Insert, SourceRecordId, TableNo, 0, OldValue, NewValue, WithValidation, false);
    end;
    ...
    var
        ...
        NewValue: FieldRef;
    begin
        Log(Enum::"VDV Log Action Type"::Delete, SourceRecordId, TableNo, 0, OldValue, NewValue, WithValidation, false);
    end;
    ...
    begin
        Log(Enum::"VDV Log Action Type"::Modify, SourceRecordId, TableNo, FieldNo, OldValue, NewValue, WithValidation, true);
    end;
    ...
    begin
        Log(Enum::"VDV Log Action Type"::Rename, SourceRecordId, TableNo, FieldNo, OldValue, NewValue, WithValidation, true);
    end;

    procedure Log(ActionType: Enum "VDV Log Action Type"; SourceRecordId: RecordId;
                                  TableNo: Integer;
                                  FieldNo: Integer;
                                  OldValue: FieldRef;
                                  NewValue: FieldRef;
                                  ...
                                  HasValues: Boolean)
    var
        DataEditorLog: Record "VDV Data Editor Log";
    begin
    ...
    begin
        if TableNo in [Database::"VDV Data Editor Setup", Database::"VDV Data Editor Log"] then
    ...
    procedure ReadRecord(var TempDataEditorBuffer: Record "VDV Data Editor Buffer" temporary; JObject: JsonObject; NumberOfThreads: Integer; TotalRecordCount: Integer) ActiveSessionId: Integer
    var
    ...
    begin
        ...
        if (NumberOfThreads > 1) and (TotalRecordCount > 500) then
            StartSession(ActiveSessionId, Codeunit::"VDV Read Data Batch", CompanyName(), TempDataEditorBuffer)
        else
            Codeunit.Run(Codeunit::"VDV Read Data Batch", TempDataEditorBuffer);
    end;

    procedure MergeBufferData(var TempDataEditorBufferResult: Record "VDV Data Editor Buffer" temporary;
        var TempDataEditorBuffer1: Record "VDV Data Editor Buffer" temporary;
        var TempDataEditorBuffer2: Record "VDV Data Editor Buffer" temporary;
        var TempDataEditorBuffer3: Record "VDV Data Editor Buffer" temporary;
        var TempDataEditorBuffer4: Record "VDV Data Editor Buffer" temporary;
        var TempDataEditorBuffer5: Record "VDV Data Editor Buffer" temporary;
        var TempDataEditorBuffer6: Record "VDV Data Editor Buffer" temporary;
        var TempDataEditorBuffer7: Record "VDV Data Editor Buffer" temporary;
        var TempDataEditorBuffer8: Record "VDV Data Editor Buffer" temporary)
    var
        PrevFilters: Text;
    begin
    ...
    var
        ...
        LogNumberSequenceLbl: Label 'VDVNSqwerty', Locked = true;
