...
codeunit 72995578 "VDV Data Operations"
{
    Permissions = tabledata "Vendor Ledger Entry" = rimd, tabledata "FA Ledger Entry" = rimd, tabledata "Job Ledger Entry" = rimd, tabledata "Item Ledger Entry" = rimd,
     ...
     tabledata "Job Register" = rimd, tabledata "Cancelled Document" = rimd, tabledata "Issued Reminder Line" = rimd, tabledata "Issued Fin. Charge Memo Line" = rimd,
     tabledata "Reminder/Fin. Charge Entry" = rimd, tabledata "Inventory Adjmt. Entry (Order)" = rimd;
