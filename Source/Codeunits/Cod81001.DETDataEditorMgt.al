...
codeunit 81001 "DET Data Editor Mgt."
{
    ...
    begin
        ...
        if IsFieldIsPartOfPK(RecRef, FieldRefVar) then begin
            ...
            DETDataOperations.RenamePKField(RecRef, FieldRefVar, SourceRecordId, ResultVariant);
            if FieldRefVar.Type() = FieldRefVar.Type::Option then begin
    ...
    begin
        DETDataOperations.RenamePKField(inRecRef, FieldRefVar, SourceRecordId, NewValueAsVariant);
    end;
    ...
    begin
        case ImportOnFind of
            ImportOnFind::Error:
                begin
                    DETDataOperations.Insert(RecRef, WithValidation);
            ...
            ImportOnFind::Modify:
                if IsRecordExist then begin
                    DETDataOperations.Modify(RecRef, WithValidation);
                    Modified += 1
                end else begin
                    DETDataOperations.Insert(RecRef, WithValidation);
                    if IsLogEnabled then
