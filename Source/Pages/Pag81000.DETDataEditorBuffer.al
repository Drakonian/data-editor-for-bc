...
page 81000 "DET Data Editor Buffer"
{
    ...
    begin
        ...
        if Rec.FindSet() then
            repeat
                DataEditorMgt.UpdateFieldByRecordIdFromVariant(
                    Rec."Source Record ID",
                    TempDETField."Field Id",
                    NewFieldRef.Value(),
                    not WithoutValidate,
                    IsLogEnabled);
            until Rec.Next() = 0;
    ...
    begin
        ...
        if Rec.FindSet() then
            repeat
                DataEditorMgt.CopyFieldValueByRecordId(
                    Rec."Source Record ID",
                    CopyFromFieldNo,
                    CopyToFieldNo,
                    not WithoutValidate,
    ...
    var
        DataEditorMgt: Codeunit "DET Data Editor Mgt.";
    begin
        DataEditorMgt.DeleteRecordByRecordId(SourceRecordID, not WithoutValidate, IsLogEnabled);
    end;
    ...
    begin
        ...
        TotalRecordCount := DataEditorMgt.GetRecordCount(RecRef.Number(), CustomTableView);
    ...
    var
        DataEditorMgt: Codeunit "DET Data Editor Mgt.";
    begin
        DataEditorMgt.RefreshBufferAfterInit(Rec, RecRef.Number(), CustomTableView, LoadFieldNoList, InitLoadDateTime);
    end;
    ...
    begin
        ...
        DataEditorMgt.UpdateFieldByRecordIdFromText(
            Rec."Source Record ID",
            OriginalFieldNo,
            NewValue,
            not WithoutValidate,
    ...
    begin
        ...
        NewValue := DataEditorMgt.GetAndApplyNewFieldValueByRecordId(
            Rec."Source Record ID",
            OriginalFieldNo,
            not WithoutValidate,
            IsLogEnabled);
