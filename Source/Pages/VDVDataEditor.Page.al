...
page 72995576 "VDV Data Editor"
{
    ...
    UsageCategory = Tasks;
    InsertAllowed = false;
    AccessByPermission = tabledata "VDV Data Editor Buffer" = RIMD;
        ...
        area(content)
        {
            group(General)
            {
                ...
                field(PresetCodeField; PresetCode)
                {
                    ...
                    trigger OnLookup(var Text: Text): Boolean
                    var
                        QueryPreset: Record "VDV Query Preset";
                        QueryPresetList: Page "VDV Query Preset";
                    begin
    ...
    var
        DataEditorBufferList: Page "VDV Data Editor Buffer";
    begin
    ...
    local procedure LoadPreset(var QueryPreset: Record "VDV Query Preset")
    var
