...
page 81004 "DET Insert New Record"
{
    ...
    begin
        ...
        if FieldVisible1 and IsFieldInitialized[1] then begin
            ...
            DataEditorMgt.SetFieldValueOnRecRef(GlobalRecRef, FieldRefToInsert.Number(), VariantValue1, not WithoutValidation);
        end;
        if FieldVisible2 and IsFieldInitialized[2] then begin
            FieldRefToInsert := GetFieldRefByCounter(2);
            DataEditorMgt.SetFieldValueOnRecRef(GlobalRecRef, FieldRefToInsert.Number(), VariantValue2, not WithoutValidation);
        end;
        if FieldVisible3 and IsFieldInitialized[3] then begin
            FieldRefToInsert := GetFieldRefByCounter(3);
            DataEditorMgt.SetFieldValueOnRecRef(GlobalRecRef, FieldRefToInsert.Number(), VariantValue3, not WithoutValidation);
        end;
        if FieldVisible4 and IsFieldInitialized[4] then begin
            FieldRefToInsert := GetFieldRefByCounter(4);
            DataEditorMgt.SetFieldValueOnRecRef(GlobalRecRef, FieldRefToInsert.Number(), VariantValue4, not WithoutValidation);
        end;
        if FieldVisible5 and IsFieldInitialized[5] then begin
            FieldRefToInsert := GetFieldRefByCounter(5);
            DataEditorMgt.SetFieldValueOnRecRef(GlobalRecRef, FieldRefToInsert.Number(), VariantValue5, not WithoutValidation);
        end;
        if FieldVisible6 and IsFieldInitialized[6] then begin
            FieldRefToInsert := GetFieldRefByCounter(6);
            DataEditorMgt.SetFieldValueOnRecRef(GlobalRecRef, FieldRefToInsert.Number(), VariantValue6, not WithoutValidation);
        end;
        if FieldVisible7 and IsFieldInitialized[7] then begin
            FieldRefToInsert := GetFieldRefByCounter(7);
            DataEditorMgt.SetFieldValueOnRecRef(GlobalRecRef, FieldRefToInsert.Number(), VariantValue7, not WithoutValidation);
        end;
        if FieldVisible8 and IsFieldInitialized[8] then begin
            FieldRefToInsert := GetFieldRefByCounter(8);
            DataEditorMgt.SetFieldValueOnRecRef(GlobalRecRef, FieldRefToInsert.Number(), VariantValue8, not WithoutValidation);
        end;
        if FieldVisible9 and IsFieldInitialized[9] then begin
            FieldRefToInsert := GetFieldRefByCounter(9);
            DataEditorMgt.SetFieldValueOnRecRef(GlobalRecRef, FieldRefToInsert.Number(), VariantValue9, not WithoutValidation);
        end;
        if FieldVisible10 and IsFieldInitialized[10] then begin
            FieldRefToInsert := GetFieldRefByCounter(10);
            DataEditorMgt.SetFieldValueOnRecRef(GlobalRecRef, FieldRefToInsert.Number(), VariantValue10, not WithoutValidation);
        end;
        if FieldVisible11 and IsFieldInitialized[11] then begin
            FieldRefToInsert := GetFieldRefByCounter(11);
            DataEditorMgt.SetFieldValueOnRecRef(GlobalRecRef, FieldRefToInsert.Number(), VariantValue11, not WithoutValidation);
        end;
        if FieldVisible12 and IsFieldInitialized[12] then begin
            FieldRefToInsert := GetFieldRefByCounter(12);
            DataEditorMgt.SetFieldValueOnRecRef(GlobalRecRef, FieldRefToInsert.Number(), VariantValue12, not WithoutValidation);
        end;
        if FieldVisible13 and IsFieldInitialized[13] then begin
            FieldRefToInsert := GetFieldRefByCounter(13);
            DataEditorMgt.SetFieldValueOnRecRef(GlobalRecRef, FieldRefToInsert.Number(), VariantValue13, not WithoutValidation);
        end;
        if FieldVisible14 and IsFieldInitialized[14] then begin
            FieldRefToInsert := GetFieldRefByCounter(14);
            DataEditorMgt.SetFieldValueOnRecRef(GlobalRecRef, FieldRefToInsert.Number(), VariantValue14, not WithoutValidation);
        end;
        if FieldVisible15 and IsFieldInitialized[15] then begin
            FieldRefToInsert := GetFieldRefByCounter(15);
            DataEditorMgt.SetFieldValueOnRecRef(GlobalRecRef, FieldRefToInsert.Number(), VariantValue15, not WithoutValidation);
        end;
        DataEditorMgt.InsertRecordFromRecRef(GlobalRecRef, not WithoutValidation);
    end;
