...
page 72995575 "VDV Data Editor Buffer"
{

    Caption = 'Data Editor Buffer';
    PageType = List;
    SourceTable = "VDV Data Editor Buffer";
    UsageCategory = None;
    ...
    actions
    {
        area(Promoted)
        {
            actionref("VDV Delete All_Promoted"; "VDV Delete All")
            {
            ...
            actionref("VDV Update Column_promoted"; "VDV Update Column")
            {

            }
            actionref("VDV Copy Column To Column_promoted"; "VDV Copy Column To Column")
            {

            }
            actionref("VDV Sort_promoted"; "VDV Sort")
            {

            }
            actionref("VDV Find & Replace_promoted"; "VDV Find & Replace")
            {
        ...
        area(Processing)
        {
            ...
            action("VDV Copy Column To Column")
            {
                ApplicationArea = All;
                Image = Column;
    ...
    var
        DataEditorPage: Page "VDV Data Editor";
    begin
    ...
    var
        FindAndReplacePage: Page "VDV Find and Replace";
    begin
    ...
    var
        TempVDVField: Record "VDV Field" temporary;
        TempNameValueBuffer: Record "Name/Value Buffer" temporary;
        DataEditorMgt: Codeunit "VDV Data Editor Mgt.";
        SelectFields: Page "VDV Select Fields";
    ...
    begin
        ...
        if SelectFields.RunModal() <> Action::LookupOK then
            exit;
        SelectFields.GetRecord(TempVDVField);
        RecRefDuplicate := RecRef.Duplicate();
        NewFieldRef := RecRefDuplicate.Field(TempVDVField."Field Id");
        if not DataEditorMgt.GetNewColumnValue(RecRef, NewFieldRef, Rec."Source Record ID", TempNameValueBuffer, not WithoutValidate) then
            exit;
        if not Confirm(ColumnUpdateConfirmLbl, false, TempVDVField.Name, Rec.Count(), RecRef.Name()) then
            exit;
        if Rec.FindSet() then
            repeat
                DataOperations.GetRecord(RecRef, Rec."Source Record ID");
                xRecRef := RecRef.Duplicate();
                FieldRefVar := RecRef.Field(TempVDVField."Field Id");
                xFieldRefVar := xRecRef.Field(TempVDVField."Field Id");
    ...
    begin
        ...
        SelectFields.GetRecord(TempVDVField);
        RecRefDuplicate := RecRef.Duplicate();
        CopyFromFieldRef := RecRefDuplicate.Field(TempVDVField."Field Id");
        ...
        SelectFields.GetRecord(TempVDVField);
        RecRefDuplicate := RecRef.Duplicate();
        CopyToFieldRef := RecRefDuplicate.Field(TempVDVField."Field Id");
    ...
    var
        DataEditorMgt: Codeunit "VDV Data Editor Mgt.";
        InsertNewRecordPage: Page "VDV Insert New Record";
    ...
    var
        TempDataEditorBuffer1: Record "VDV Data Editor Buffer" temporary;
        TempDataEditorBuffer2: Record "VDV Data Editor Buffer" temporary;
        TempDataEditorBuffer3: Record "VDV Data Editor Buffer" temporary;
        TempDataEditorBuffer4: Record "VDV Data Editor Buffer" temporary;
        TempDataEditorBuffer5: Record "VDV Data Editor Buffer" temporary;
        TempDataEditorBuffer6: Record "VDV Data Editor Buffer" temporary;
        TempDataEditorBuffer7: Record "VDV Data Editor Buffer" temporary;
        TempDataEditorBuffer8: Record "VDV Data Editor Buffer" temporary;
        DataEditorMgt: Codeunit "VDV Data Editor Mgt.";
