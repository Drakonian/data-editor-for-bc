codeunit 72996810 "VDVT Library - Data Editor"
{
    procedure VerifyBufferFieldsWithSourceRecord(var DataEditorBuffer: TestPage "VDV Data Editor Buffer"; ListOfRecordIds: List of [RecordId]; FieldNoFilter: List of [Integer]; ExcludeFlowFields: Boolean)
    var
        Assert: Codeunit "Library Assert";
        DataEditorBufferHelper: Codeunit "VDVT Data Editor Buffer Helper";
