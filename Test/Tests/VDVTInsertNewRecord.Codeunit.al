codeunit 72996802 "VDVT Insert New Record"
{
    Subtype = Test;
    ...
    var
        ...
        MsgOnSalesHeaderInsert: Codeunit "VDVT Msg On SalesHeader Insert";
    ...
    [ModalPageHandler]
    procedure InsertNewRecordTestPKHandler(var InsertNewRecord: TestPage "VDV Insert New Record")
    begin
        InsertNewRecord.OK().Invoke();
    end;
